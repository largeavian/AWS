...
file="/home/ec2-user/list-centrallog.txt"
YELLOW='\033[1;33m'
RED='\033[1;31m'
BLUE='\033[1;34m'
NC='\033[0m'
                    ...
                    echo -e ...on ${YELLOW}$id${NC}...
                        ...
                        do
                            echo -e ...in ${BLUE}$region${NC}...
                                ...
                                aws guardduty create-members --account-details AccountId=$id,Email=$email --detector-id 06b103362eb17f7403f76f8345701654
                                aws guardduty invite-members --account-ids $id --detector-id 06b103362eb17f7403f76f8345701654
                        done < "$file3"
